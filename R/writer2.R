...
wrUImainA1 <- function(prefix, ptsiz) {
  glue::glue(
    ...
    '        br(), \n',
    '        conditionalPanel( \n',
    '          condition = "input.{prefix}a1ass1.startsWith(\'Assay: \')", \n',
    '          fluidRow(column(12, htmlOutput("{prefix}a1lnk1"))) \n',
    '        ), \n',
    '      ), # End of column (6 space) \n',
    '      column(\n',
    '        3, h4("Cell numbers"), \n',
...
wrUImainA2 <- function(prefix, ptsiz) {
  glue::glue(
    ...
    '        br(), \n',
    '        conditionalPanel( \n',
    '          condition = "input.{prefix}a2ass1.startsWith(\'Assay: \')", \n',
    '          fluidRow(column(12, htmlOutput("{prefix}a2lnk1"))) \n',
    '        ) \n',
    '      ), # End of column (6 space)\n',
    '      column( \n',
    '        6,\n',
    ...
    '        br(), \n',
    '        conditionalPanel( \n',
    '          condition = "input.{prefix}a2ass2.startsWith(\'Assay: \')", \n',
    '          fluidRow(column(12, htmlOutput("{prefix}a2lnk2"))) \n',
    '        ) \n',
    '      )  # End of column (6 space) \n',
    '    ),   # End of fluidRow (4 space) \n',
...
wrUImainB1 <- function(prefix, ptsiz) {
  glue::glue(
    ...
    '        br(), br(), \n',
    '        conditionalPanel( \n',
    '          condition = "input.{prefix}b1ass1.startsWith(\'Assay: \')", \n',
    '          fluidRow(column(12, htmlOutput("{prefix}b1lnk1"))) \n',
    '        ), \n',
    '        conditionalPanel( \n',
